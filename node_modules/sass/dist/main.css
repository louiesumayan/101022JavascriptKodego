...
.btn-link {
  ...
  --bs-btn-focus-shadow-rgb: 136, 80, 80;
  text-decoration: underline;
}
...
.alert-pogi {
  --bs-alert-color: #006666;
  --bs-alert-bg: #ccffff;
  --bs-alert-border-color: #b3ffff;
}
.alert-pogi .alert-link {
  color: #005252;
}
...
.list-group-item-pogi {
  color: #006666;
  background-color: #ccffff;
}
.list-group-item-pogi.list-group-item-action:hover, .list-group-item-pogi.list-group-item-action:focus {
  color: #006666;
  background-color: #b8e6e6;
}
.list-group-item-pogi.list-group-item-action.active {
  color: #fff;
...
.link-pogi:hover, .link-pogi:focus {
...
.border-pogi {
  --bs-border-opacity: 1;
  border-color: rgba(var(--bs-pogi-rgb), var(--bs-border-opacity)) !important;
}
...
.text-pogi {
  --bs-text-opacity: 1;
  color: rgba(var(--bs-pogi-rgb), var(--bs-text-opacity)) !important;
}
...
.bg-pogi {
  --bs-bg-opacity: 1;
  background-color: rgba(var(--bs-pogi-rgb), var(--bs-bg-opacity)) !important;
}
